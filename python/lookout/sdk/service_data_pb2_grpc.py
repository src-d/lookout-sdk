...
from lookout.sdk import service_data_pb2 as lookout_dot_sdk_dot_service__data__pb2
...
def add_DataServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetChanges': grpc.unary_stream_rpc_method_handler(
          servicer.GetChanges,
          request_deserializer=lookout_dot_sdk_dot_service__data__pb2.ChangesRequest.FromString,
          response_serializer=lookout_dot_sdk_dot_service__data__pb2.Change.SerializeToString,
      ),
      'GetFiles': grpc.unary_stream_rpc_method_handler(
          servicer.GetFiles,
          request_deserializer=lookout_dot_sdk_dot_service__data__pb2.FilesRequest.FromString,
          response_serializer=lookout_dot_sdk_dot_service__data__pb2.File.SerializeToString,
      ),
  }
