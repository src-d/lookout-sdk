...
from lookout.sdk import service_analyzer_pb2 as lookout_dot_sdk_dot_service__analyzer__pb2
...
def add_AnalyzerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'NotifyReviewEvent': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=lookout_dot_sdk_dot_event__pb2.ReviewEvent.FromString,
          response_serializer=lookout_dot_sdk_dot_service__analyzer__pb2.EventResponse.SerializeToString,
      ),
      'NotifyPushEvent': grpc.unary_unary_rpc_method_handler(
          servicer.NotifyPushEvent,
          request_deserializer=lookout_dot_sdk_dot_event__pb2.PushEvent.FromString,
          response_serializer=lookout_dot_sdk_dot_service__analyzer__pb2.EventResponse.SerializeToString,
      ),
  }
